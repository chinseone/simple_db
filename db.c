...
void* get_page(Pager* pager, uint32_t page_num) {
    ...
    {
        printf("Tried to fetch page number out of boundary %d", page_num);
        exit(EXIT_FAILURE);
    }
...
typedef enum { PREPARE_SUCCESS, PREPARE_NEGATIVE_ID, PREPARE_UNRECOGNIZED_STATEMENT, PREPARE_SYNTAX_ERROR, PREPARE_STRING_TOO_LONG } PrepareResult;
